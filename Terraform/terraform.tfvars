/************************************************************************************************************************************************
  ...
  Custom Configuration
        ...
        Most of the configurations you will want to change for a functional Dev are located here. While you can modify any part of the 
...
resource_group_name                      = "DEV-Synapse-Analytics"                // Resource Group for all related Azure services.
...
synapse_sql_administrator_login_password = "Pass@word123IntelliEnergy"            // Password for the native SQL admin account above.
